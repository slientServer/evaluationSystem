<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
	<form method="post" action="/workspace/simpsons/trunk/server/Admin/News/update/navTabId/listnews/callbackType/closeCurrent"  class="pageForm required-validate" 
		onsubmit="return validateCallback(this,dialogAjaxDone);"><?php  ?>
		<input type="hidden" name="newsid" value="<?php echo ($vo["newsid"]); ?>"/>
		<div class="pageFormContent" layoutH="60">
			<dl>
				<dt>新闻标题：</dt>
				<dd><input type="input"  style="width:568px" name="newstitle" value="<?php echo ($vo["newstitle"]); ?>"/></dd>
			</dl>
			<dl>
				<dt>新闻内容：</dt>
				<dd><textarea id="elm1" rows="28" style="width:568px" name="newscontent"><?php echo ($vo["newscontent"]); ?>
					</textarea>
					<script>
