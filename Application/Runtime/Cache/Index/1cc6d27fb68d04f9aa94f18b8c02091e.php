...
<script>
    $(document).ready(function(){
        ...
        $("#confirmBuyInfo").click(function(evt){
            ...
            dynamicPopupGroup.addNewPopup("confirmExchangeInfo","<?php echo U('WScreen/confirmExchangeInfo');?>",{'scoreproductid': productid}, {forceReload:true,closeButton:true, afterclose:function(){
    ...
    <div style='text-align:center;margin-left;auto;margin-right:auto;overflow:hidden;'>
        ...
        <div style="text-align:left;float:right;width:40%;padding:5px;bottom:40px;position:absolute;right:0px;">
            ...
            <div style="font-size:15px;font-weight:bold;padding-top:20px;">
                <?php echo ($product["scoreproductdescription"]); ?>
            </div>
            <?php if($product["scorecondition"] > $totalscore): ?><div id='confirmDisabled' style="text-align:center;margin:auto;padding-top:40px;">
                    <img productid="<?php echo ($product["scoreproductid"]); ?>"  src="/workspace/simpsons/trunk/server/Application/Index/View/default/Public/images/confirmExchangeDisabled.png" style="width:60%">
                  </div>  
              <?php else: ?>
                  <div id='confirmBuyInfo' style="text-align:center;margin:auto;padding-top:40px;">
                    <img productid="<?php echo ($product["scoreproductid"]); ?>"  src="/workspace/simpsons/trunk/server/Application/Index/View/default/Public/images/confirmExchange.png" style="width:60%">
                  </div><?php endif; ?>
