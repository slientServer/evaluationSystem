...
$("#confirmBuyFinal").click(function(evt){
        ...
        dynamicPopupGroup.addNewPopup("confirmExchangeFinal","<?php echo U('WScreen/confirmExchangeFinal');?>",{'scoreproductid': productid, 'name': name, 'phone': phone, 'mainaddress': mainaddress, 'address': address}, {forceReload:true,closeButton:true, afterclose:function(){
	...
	<tr>
		<td style="width:45%;height:100%;">
			<div style="height:80%;width:100%;background-image:url('/workspace/simpsons/trunk/server/Application/Index/View/default/Public/images/MarketPlaceProductSingle.png');background-size: 100% 100%;padding-top:10px;text-align:center;">
				<img src="/workspace/simpsons/trunk/server/<?php echo ($product["scoreproductpic"]); ?>" style="width:98%;">
		...
		<td style="">
			<div style="padding-left:20px;width:250px;">
				...
				<div id='confirmBuyFinal' style="padding-top:10px;width:100%;text-align:center;">
					<div productid="<?php echo ($product["scoreproductid"]); ?>" style="margin:auto;background-image:url('/workspace/simpsons/trunk/server/Application/Index/View/default/Public/images/confirmBuy.png');background-size: 143px 35px;width:143px;height:35px;">
					</div>
				</div>
			</div>
		</td>
