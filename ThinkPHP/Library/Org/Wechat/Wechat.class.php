...
class Wechat {
    ...
    public function __construct() {
        ...
        $this->encodingAesKey = isset($options['ENCODING_AES_KEY']) ? $options['ENCODING_AES_KEY'] : '';
        $this->appid = isset($options['APP_ID']) ? $options['APP_ID'] : '';
        $this->appsecret = isset($options['APP_KEY']) ? $options['APP_KEY'] : '';
    ...
    protected function log($log) {
        if ($this->debug) {
            return Log::record($log, Log::DEBUG, true);
        }
    }
